  ...
  return (
    <footer className="site-footer">
      <div className="footer-top" aria-label="Footer call to action">
        <div className="footer-top__inner">
          <div className="footer-cta">
            ...
            <p>
              Connect with Shinemed Pharmaceuticals Pvt Ltd for assistance, availability, and general
              inquiries.
            </p>
          </div>
      ...
      <div className="footer-main">
        <nav
          className="footer-links footer-links--quick"
        ...
        <div className="footer-brand-panel">
          ...
          <p>
            Shinemed Pharmaceuticals Pvt Ltd provides trusted, accessible healthcare products and
            services to support every family.
          </p>
      ...
      <div className="footer-bottom">
        ...
        <div className="footer-bottom__links" aria-label="Footer links">
